...
public class VerticalLayout extends AbstractPolicyLayout {
    ...
    private void updateInitial(IPencil pen, IBounds parent, List<WaveComponent> children, List<Object> childArgs, List<IEditableBounds> bounds) {
    ...
    private void updateStretch(IPencil pen, IBounds parent, List<WaveComponent> children, List<Object> childArgs, List<IEditableBounds> bounds, boolean force) {
        Float[] childHeights = new Float[children.size()];
    ...
    private void updateSpread(IPencil pen, IBounds parent, List<WaveComponent> children, List<Object> childArgs, List<IEditableBounds> bounds) {
        float[] childHeights = new float[children.size()];
    ...
    private void updateBounds(IPencil pen, IBounds parent, WaveComponent child, IEditableBounds childBounds, float y, float height){
        float width = 0;
...
//            Float minHeight = child.minHeight(pen);
    ...
    public VerticalLayout padding(float padding){
        this.padding = padding;
        return this;
    }
